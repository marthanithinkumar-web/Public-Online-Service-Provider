  ...
  return <header className="site-header">
    <div className="container site-header-inner">
      ...
      <div className="header-actions">
        ...
        {!authenticated&&<><Link className="header-link" to="/login" onMouseEnter={preloadLogin} onFocus={preloadLogin}>Login</Link><Link className="header-link" to="/admin/login">Admin Login</Link><Link className="header-signup" to="/register">Register</Link></>}
