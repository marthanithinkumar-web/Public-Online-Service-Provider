...
export default function UniversalServiceRequest(){
 ...
 const fields=useMemo<Field[]>(()=>{
  ...
  const source:Field[]=scholarship?[...SCHOLARSHIP_FIELDS,...serviceFields]:job?[...jobFeeFields,...JOB_FIELDS,...serviceFields]:serviceFields.length?serviceFields:FALLBACK_FIELDS
