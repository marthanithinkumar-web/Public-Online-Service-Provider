...
export default function Terms(){
  return <PublicInfoPage eyebrow="Terms of assistance" title="Clear responsibilities and charges" intro="These terms explain the role of the private assistance provider and what clients should expect.">
    <section><h2>Service operator</h2><p>Public Online Service Provider is a product operated under the trade name MNK Technologies by its proprietor. MNK Technologies is not presented as a private limited or incorporated company.</p></section>
