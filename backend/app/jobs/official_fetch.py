...
ALLOWED_HOSTS = {
    ...
    'navodaya.gov.in', 'www.navodaya.gov.in',
    'sainikschoolsociety.in', 'www.sainikschoolsociety.in',
    'kvsangathan.nic.in', 'www.kvsangathan.nic.in',
    'sebi.gov.in', 'www.sebi.gov.in',
    'ibps.in', 'www.ibps.in',
    'rac.gov.in', 'www.rac.gov.in',
    'careers.wipro.com',
